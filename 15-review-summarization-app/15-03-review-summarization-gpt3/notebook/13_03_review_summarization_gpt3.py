# -*- coding: utf-8 -*-
"""review_summarization_gpt3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1O0a9GZfkjM8qCSextB4UPcJMl6j5E0sD
"""
...
def summarize_with_gpt(product_name, reviews):
    try:
...
def summarize_from_csv(product_name, file, column_name="review_text"):
    try:
        ...
        return summarize_with_gpt(product_name, reviews)
    except Exception as e:
        return f"Error processing CSV: {str(e)}"

with gr.Blocks() as demo:
    gr.Markdown("##  Review Summarization App (GPT-3.5 via Colab Secrets)")
    ...
    manual_button.click(
        lambda name, text: summarize_with_gpt(name, text.split("\n")),
